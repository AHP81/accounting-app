...
export default function TradingCard({ data }: Props) {
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-4 lg:gap-8">
            ...
            <span className={`text-base lg:text-lg font-bold ${
                totals.toman >= 0 ? "text-green-500" : "text-red-500"
            }`}>
              {format(totals.toman)}
            </span>
                        ...
                        <div className="relative flex flex-col items-center justify-center text-center">
            <span className={`text-base lg:text-lg font-bold ${
                totals.usd >= 0 ? "text-green-500" : "text-red-500"
            }`}>
              {format(totals.usd)}
            </span>
                            <div className="text-xs lg:text-sm text-gray-600">
            ...
            <span className={`text-base lg:text-lg font-bold ${
                totals.iqd >= 0 ? "text-green-500" : "text-red-500"
            }`}>
              {format(totals.iqd)}
            </span>
                            <div className="text-xs lg:text-sm text-gray-600">
